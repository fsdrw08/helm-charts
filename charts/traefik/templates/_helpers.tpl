...
{{- include "common.images.pullSecrets" (dict "images" (list .Values.traefik.image .Values.%%SECONDARY_OBJECT_BLOCK%%.image .Values.volumePermissions.image) "global" .Values.global) -}}
{{- end -}}
