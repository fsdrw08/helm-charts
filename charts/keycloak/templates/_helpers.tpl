...
{{- include "common.images.renderPullSecrets" (dict "images" (list .Values.keycloak.image .Values.%%SECONDARY_OBJECT_BLOCK%%.image .Values.volumePermissions.image) "context" $) -}}
{{- end -}}
