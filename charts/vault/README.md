...
```powershell
$releaseName="vault"
helm template .\charts\vault --name-template=$releaseName -f .\charts\vault\values-sololab.yaml | podman kube play -
```
...
```powershell
$releaseName="vault"
helm template .\charts\vault --name-template=$releaseName | podman kube play -
```

The command deploys vault on the podman host in the default configuration. The [Parameters](#parameters) section lists the parameters that can be configured during installation.
...
```powershell
helm template .\charts\vault --name-template=$releaseName | podman kube play --down -
```
