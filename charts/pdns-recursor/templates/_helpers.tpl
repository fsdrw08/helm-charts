...
{{ include "common.images.image" (dict "imageRoot" .Values.powerdns.image "global" .Values.global) }}
{{- end -}}
...
{{- include "common.images.renderPullSecrets" (dict "images" (list .Values.powerdns.image  .Values.volumePermissions.image) "context" $) -}}
{{- end -}}
