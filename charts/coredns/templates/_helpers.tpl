...
{{- include "common.images.renderPullSecrets" (dict "images" (list .Values.coredns.image .Values.defaultInitContainers.volumePermissions.image) "global" .Values.global) -}}
{{- end -}}
